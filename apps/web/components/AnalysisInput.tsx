  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <Tabs.Root value={mode} onValueChange={(v: string) => setMode(v as InputMode)}>
        <Tabs.List
          className="flex gap-1 mb-4 bg-gray-100 rounded-xl p-1"
          ...
          <div className="flex gap-2">
            {hasContent && (
              <button
                ...
                aria-label="Clear"
                onClick={handleClear}
                className="px-4 py-3 rounded-xl font-medium text-gray-600 border border-gray-200 hover:bg-gray-50 transition-colors flex items-center gap-2"
              >
                <X size={16} />
                Clear
              </button>
